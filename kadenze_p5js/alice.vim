...
inoremap <silent> <SNR>65_AutoPairsReturn =AutoPairsReturn()
...
set guifont=Terminus_(TTF):h10:cRUSSIAN
set guioptions=gt
set helplang=Bu
set hidden
set hlsearch
...
set pastetoggle=<F9>
set runtimepath=~/vimfiles,~\\vimfiles\\bundle\\Vundle.vim,~\\vimfiles\\bundle\\nerdtree,~\\vimfiles\\bundle\\L9,~\\vimfiles\\bundle\\FuzzyFinder,~\\vimfiles\\bundle\\lightline.vim,~\\vimfiles\\bundle\\vim-easymotion,~\\vimfiles\\bundle\\vim-surround,~\\vimfiles\\bundle\\jshint2.vim,~\\vimfiles\\bundle\\emmet-vim,~\\vimfiles\\bundle\\vim-coffee-script,~\\vimfiles\\bundle\\vim-less,~\\vimfiles\\bundle\\vim-css-color,~\\vimfiles\\bundle\\vim-css3-syntax,~\\vimfiles\\bundle\\vim-jade,~\\vimfiles\\bundle\\vim-javascript-syntax,~\\vimfiles\\bundle\\vim-airline,~\\vimfiles\\bundle\\YouCompleteMe,~\\vimfiles\\bundle\\vim-javascript,~\\vimfiles\\bundle\\auto-pairs,~\\vimfiles\\bundle\\closetag,~\\vimfiles\\bundle\\vim-monokai,~\\vimfiles\\bundle\\vim-airline-themes,~\\vimfiles\\bundle\\vim-indent-guides,C:\\Program\ Files\ (x86)\\Vim/vimfiles,C:\\Program\ Files\ (x86)\\Vim\\vim74,C:\\Program\ Files\ (x86)\\Vim/vimfiles/after,~/vimfiles/after,$HOME/vimfiles,$HOME/vimfiles/bundle/Vundle.vim,$HOME/vimfiles,$HOME/vimfiles/bundle/Vundle.vim,~\\vimfiles\\bundle\\Vundle.vim/after,~\\vimfiles\\bundle\\nerdtree/after,~\\vimfile
set scrolloff=3
set shiftwidth=4
set showtabline=2
set smartindent
...
set shortmess=aoO
badd +186 ~\.vimrc
badd +16 assignment6\index.html
badd +15 assignment6\sketch.js
badd +34 exercise-alice\sketch.js
badd +0 exercise-alice\index.html
argglobal
silent! argdel *
edit exercise-alice\sketch.js
...
exe 'vert 1resize ' . ((&columns * 30 + 191) / 383)
exe 'vert 2resize ' . ((&columns * 117 + 191) / 383)
exe 'vert 3resize ' . ((&columns * 117 + 191) / 383)
exe 'vert 4resize ' . ((&columns * 116 + 191) / 383)
argglobal
enew
file NERD_tree_1
let s:cpo_save=&cpo
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 34 - ((32 * winheight(0) + 45) / 90)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 186 - ((69 * winheight(0) + 45) / 90)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
186
...
wincmd w
argglobal
edit exercise-alice\index.html
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <BS> =AutoPairsDelete()
inoremap <buffer> <silent> î :call AutoPairsJump()a
